...
const comments = [
    ...
    },
    {
        ...
        description: 'Create what you want and what your audience loves. You don’t have to' + ' conform to popular taste or the constraints of ad-based monetization models.',
    ...
    },
    {
        ...
        description: 'No ads, no trolls, no algorithms. Enjoy direct access and deeper conversations with' + ' the people who matter the most.',
        name: 'Heather McDonald',
        job: 'Juicy Scoop Podcast',
        info: 'With Patreon, it’s not about likes and views, you can really connect with your fans,' + ' ignore the haters and focus on the positive. I’d rather have 300 patrons than 3 million Instagram followers.',
    },
]
...
const customers = [
    ...
    },
    {
        ...
        description:
            'Creating a successful podcast shouldn’t involve compromising your vision,' +
...
const blogs = [
    {
        ...
        description: 'In this article, we want to introduce you to the membership model—an' + ' effective, field-tested way for independent creators...',
        href: '/blog1',
    },
    {
        imgDetails: {
        ...
        description: 'If you’ve looked at what other creators are doing on Patreon, it can be' + ' daunting to see how many different ways they leverage...',
        href: '/blog2',
    },
    {
        imgDetails: {
        ...
        description: "As a creator, it's easy to feel like there just aren't enough hours in the" + " day. Whether you're working on your project part time...",
        href: '/blog3',
    },
]
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                <div className={styles.headers}>
                    <h1 className={styles.heading}>Change the way art is valued</h1>
                    <h3 className={styles.caption}>Let your most passionate fans support your creative work via monthly membership.</h3>
            ...
            <div className={styles.search}>
                <h1>Search the 200,000+ creators on Patreon</h1>
                <form>
                    <div>
            ...
            <div className={styles.about}>
                ...
                <p>
                    On Patreon, you can let your fans become active participants in the work they love by offering them a monthly membership. You give them access to exclusive content, community, and insight into your
                    creative process. In exchange, you get the freedom to do your best work, and the stability you need to build an independent creative career.
                </p>
            </div>
            ...
            <div className={styles.customers}>
                <h1 className={styles.title}>Who uses Patreon?</h1>
                <p className={styles.description}>If you’re ready to take your work to the next level and willing to open your heart to your audience, Patreon is for you.</p>
            </div>
            ...
            <div className={styles.blogs}>
                <h1>See how other creators use Patreon</h1>
