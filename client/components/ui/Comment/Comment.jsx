...
import { IoArrowBack, IoEllipsisHorizontalSharp, IoHeart, IoHeartOutline, IoBookmarkOutline, IoBookmark, IoChatboxOutline, IoEllipsisVerticalSharp, IoShareSocialOutline } from "react-icons/io5"
      ...
      <div className={styles.tweet}>
        <div className={styles.image}>
          <div className={styles.info}>
            <Image src={session && session.user.image} width={50} height={50} alt="user image" />
        ...
        <p className={styles.content}>If 46600$ was strong support for #BTC, 47600$ will be strong resistance ahead of #Bitcoin.</p>
