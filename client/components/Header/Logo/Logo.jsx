...
export default function Logo() {
    ...
    return (
        <Link href={isAuth ? '/home' : '/'} passHref>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="40.000000pt" height="40.000000pt" viewBox="0 0 66.000000 79.000000" preserveAspectRatio="xMidYMid meet">
                <g transform="translate(0.000000,79.000000) scale(0.100000,-0.100000)" fill="#888" stroke="none">
                    <motion.path
